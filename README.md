...
| Python Version | Platform | Release Date | Download |
|----------------|----------|--------------|----------|
| 3.13.9 | Linux x86_64 | 2025-11-29 | [tar.gz](https://github.com/anubhavkrishna1/python3-binary/releases/download/python-3.13.9-linux/python-3.13.9-linux-x86_64.tar.gz) \| [zip](https://github.com/anubhavkrishna1/python3-binary/releases/download/python-3.13.9-linux/python-3.13.9-linux-x86_64.zip) |
...
| Python Version | Platform | Release Date | Download |
|----------------|----------|--------------|----------|
| 3.10.19 | Linux x86_64 | 2025-11-29 | [tar.gz](https://github.com/anubhavkrishna1/python3-binary/releases/download/python-3.10.19-linux-glibc236/python-3.10.19-linux-glibc236-x86_64.tar.gz) \| [zip](https://github.com/anubhavkrishna1/python3-binary/releases/download/python-3.10.19-linux-glibc236/python-3.10.19-linux-glibc236-x86_64.zip) |
| 3.9.25 | Linux x86_64 | 2025-11-29 | [tar.gz](https://github.com/anubhavkrishna1/python3-binary/releases/download/python-3.9.25-linux-glibc236/python-3.9.25-linux-glibc236-x86_64.tar.gz) \| [zip](https://github.com/anubhavkrishna1/python3-binary/releases/download/python-3.9.25-linux-glibc236/python-3.9.25-linux-glibc236-x86_64.zip) |
| 3.9.22 | Linux x86_64 | 2025-07-01 | [tar.gz](https://github.com/anubhavkrishna1/python3-binary/releases/download/python-3.9.22-linux-glibc236/python-3.9.22-linux-glibc236-x86_64.tar.gz) \| [zip](https://github.com/anubhavkrishna1/python3-binary/releases/download/python-3.9.22-linux-glibc236/python-3.9.22-linux-glibc236-x86_64.zip) |
